    ...
    <AnimatedSection className="px-[1.5rem] sm:relative overflow-hidden">
      ...
      <div className="sm:px-20 sm:grid sm:grid-cols-3 sm:gap-10 sm:items-start">
        <div className="sm:border-t-[1px] sm:border-gray-500 sm:pt-14">
          <h2 className="text-xs sm:text-sm text-headingColor font-semibold uppercase dark:text-foreground">
            WHO WE ARE
          </h2>
        </div>
        ...
        <div className="sm:border-t-[1px] sm:border-gray-500 sm:pt-14 sm:col-span-2">
          <div>
            <h3 className="text-3xl sm:text-5xl leading-10 font-semibold font-tinos tracking-wide dark:text-foreground">
          ...
          <div>
            <p className="text-md sm:text-lg text-paragraph leading-relaxed dark:text-foreground">
